...
public class ImagePicker {
    ...
    public ImagePicker showWebPImage(boolean showWebPImage) {
        PickerConfigManager.getInstance().setShowWebPImage(showWebPImage);
        return mImagePicker;
    }
     ...
     * @return
     */
    public ImagePicker setImageLoader(PickerImageLoader imageLoader) {
        PickerConfigManager.getInstance().setImageLoader(imageLoader);
        return mImagePicker;
    }
