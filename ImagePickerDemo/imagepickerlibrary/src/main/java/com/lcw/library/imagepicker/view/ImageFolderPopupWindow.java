...
public class ImageFolderPopupWindow extends PopupWindow {
    ...
    public ImageFolderPopupWindow(Context context, List<PickerMediaFolder> mediaFolderList) {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.sdk_picker_window_image_folders, null);
    ...
    private void initPopupWindow(View view) {
        setContentView(view);
        int[] screenSize = PickerUtils.getScreenSize(mContext);
