 ...
 */
public class PickerPinchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == PickerPinchImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PickerPinchImageView pinchImageView);
    }
    ...
    public PickerPinchImageView(Context context) {
        super(context);
        initView();
    }

    public PickerPinchImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PickerPinchImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PickerPinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PickerPinchImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PickerPinchImageView.this);
            }
            return true;
        }
    });
