 ...
 */
public class PickerVideoScanner extends AbsMediaScanner<PickerMediaFile> {

    public static final int ALL_IMAGES_FOLDER = -1;//全部图片

    private Context mContext;

    public PickerVideoScanner(Context context) {
        super(context);
     ...
     */
    @Override
    protected PickerMediaFile parse(Cursor cursor) {
        ...
        PickerMediaFile mediaFile = new PickerMediaFile();
